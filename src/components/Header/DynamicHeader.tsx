...
export default function DynamicHeader({
  ...
  return (
    <View className="flex-row items-center justify-evenly px-4 py-3" style={[{
      ...
      {/* Title */}
      <Text className="text-lg font-bold flex-1 text-start" numberOfLines={2} ellipsizeMode="tail" style={{ maxWidth: '100%', textAlign: 'center', fontWeight: '700', fontSize: gpsh(16), color: colors?.textPrimary }}>
        {title}
      </Text>
